            ...
            child: Column(
              ...
              children: [
                ...
                if (viewModel.isRegisterState) ...[
                  formFieldBuilder(userNameController, 'User Name', context),
                  if (viewModel.hasUserNameValidationMessage)
                    errorTextBuilder(viewModel.userNameValidationMessage!),
                ],
                ...
                if (!viewModel.isForgetPassowrdState) ...[
                  formFieldBuilder(passwordController, 'Password', context),
                ...
                ElevatedButton(
                  ...
                  child: Text(viewModel.isLoginState ? 'Register' : 'Login'),
                ),
              ],
            ),
          ),
